...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    ...
    // we trigger a side-effect using LaunchedEffect every time the input changes
    // and call the onToDestinationChanged lambda
    LaunchedEffect(editableUserInputState) {
        // use snapshotFlow to convert Compose State<T> objects into a Flow
