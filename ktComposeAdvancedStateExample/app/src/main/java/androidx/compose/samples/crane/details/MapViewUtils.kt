...
//    }
     ...
     *
     * remember the view object in composition
     */
    ...
    // get the current lifecycle from compose
    val lifecycle = LocalLifecycleOwner.current.lifecycle
    /* clean up the side effect
     * With the key1 and key2 in DisposableEffect, should lifecycle or mapView
     * change, the observer will be removed and added again to the right lifecycle
     *
     * With the following code, MapView will always follow the lifecycle
     * of the current LifecycleOwner and its behavior would be
     * just as if it was used in the View world
     */
