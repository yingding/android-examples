...
class TransferLearningHelper(
    ...
    private fun setupModelPersonalization(): Boolean {
        ...
        return try {
            // used the model from the assets folder, instead of model/assets, since it is an empty model
            // https://www.tensorflow.org/lite/api_docs/java/org/tensorflow/lite/support/common/FileUtil#loadMappedFile(Context,%20java.lang.String)
            val modelFile = FileUtil.loadMappedFile(context, "model.tflite")
            Log.v(TAG, "modelFile $modelFile")
